  ...
  return (
    <>
      ...
      <div className={cn(
        ...
        {/* Logo and Toggle */}
        <div className={cn("flex items-center border-b border-gray-200", isCollapsed ? "p-2 justify-center" : "p-4 justify-between")}>
          {!isCollapsed && (
          ...
          <Button
            ...
            className="hidden md:flex p-1 h-8 w-8 items-center justify-center"
          >
