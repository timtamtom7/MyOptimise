...
import { AnalyticsService, ServiceAnalytics } from '@/lib/analytics-service'
...
export default function ServiceList({ userId, accountId, userRole }: ServiceListProps) {
  ...
  useEffect(() => {
    const initAnalyticsService = async () => {
      try {
        const service = new AnalyticsService(userId, accountId, userRole)
